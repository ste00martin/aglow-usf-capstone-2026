 ...
 */
function topFromLogits(logits: Float32Array, labels: string[]): { label: string; score: number } {
  // Softmax
...
async function cropFace(photoUri: string, bbox: BBox, photoW: number, photoH: number): Promise<string> {
